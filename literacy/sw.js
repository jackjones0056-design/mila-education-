const CACHE = 'kindergarten-literacy-mission-v4';
const ASSETS = ['./','./index.html','./styles.css','./app.js','./data.js','./manifest.webmanifest','./worksheets.html','./worksheets.css','./wsdata.js','./wsrender.js','../icons/icon-192.png'];
